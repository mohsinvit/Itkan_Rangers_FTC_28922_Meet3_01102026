...
@Autonomous
public class RangersRedAuton extends LinearOpMode{
    ...
    private void shoot(int velocity){
        ...
        if((aligned || x == 0) &&(target - currentVelo) < 20) {
    ...
    private void turn(int angle){
        ...
        while (Math.abs(currentAngle - angle) > 0.5){
            ...
            pow = Math.min(Math.max(pow,-0.5),0.5);
    ...
    private void strafe(double inches, double power){
     ...
     private void initAprilTag() {
        try {
            ...
            // Make sure Webcam name matches your configuration exactly
            ...
            telemetry.addData("Error", "Failed to initialize AprilTag: " + e.getMessage());
        }
     }
    ...
    public void initHardware(){
        ...
        // Initialize AprilTag LAST after other hardware
        initAprilTag();
